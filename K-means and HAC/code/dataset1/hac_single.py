...
def main():
    ...
    dendrogram_filename = make_filename("visuals/dataset1/hac_single/dendrogram/", "dendrogram")
    ...
    for k in range(initial_k, final_k+1):
        ...
        cluster_filename = make_filename("visuals/dataset1/hac_single/cluster_graphs/", "cluster", k)

...
def main():
    ...
    dendrogram_filename = make_filename("visuals/dataset1/hac_average/dendrogram/", "dendrogram")
    plot_dendrogram(Z, dendrogram_filename, max_d=3)
    ...
    for k in range(initial_k, final_k+1):
        ...
        cluster_filename = make_filename("visuals/dataset1/hac_average/cluster_graphs/", "cluster", k)
